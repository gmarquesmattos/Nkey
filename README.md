...
## Descrição
Objetivo desse projeto, é Automatizar os testes funcionais do Front-End do sistema *vendee*.
...
- Realizar o clone do projeto usando o comando Git Clone e a URL  
...
- Para executar todos os testes basta ir até o caminho: SRC->Test->Resources->Suites-> botão direito no arquivo Negocio.xml na opção "Run"
...
# Dúvidas
 Procurar Time de Qualidade para suporte @guilherme_mattos  )
